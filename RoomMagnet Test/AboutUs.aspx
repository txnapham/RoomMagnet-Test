...
<!--End of Header Image-->       
            ...
            <section class="px-5 py-5  shadow-sm " id="whoAreWe">
                <div class="row">
                    <div class="col-md-12">
                        <h3>Who are we?</h3>
            ...
            <section class="px-5 py-5  shadow-sm " id="ourGoals">
                <div class="row">
                    <div class="col-md-12">
                        <h3>Our Goals</h3>
            ...
            <section class="px-5 py-5  shadow-sm " id="faQs">
                <div class="row">
                    <div class="col-md-12">
                        <h3>Frequently Asked Questions</h3>
                           ...
                           <h5>Who are host families?</h5> 
                            <p>Host families are those who have room in their home, empty-nesters and people of advanced age who wish to age in place, and wish to monetize their empty space. In cases where hosts are interested in getting a little help around the house and tenants are willing to provide assistance with things such as light domestic or outdoor work, running errands, as well as companionship a further rent discount will be offered by the host and negotiated between host and tenant.</p>
                           ...
                           <h5>Why is there a need for RoomMagnet?</h5> 
                            <p>As the cost of housing increases and become more scare in highly populated areas, it becomes harder for responsible students, as well as professional and semi-professionals (ie: doctoral interns, and interning nurses) to find suitable and affordable housing. Likewise, International students not only have the added expense of international living, but also must adjust to the cultural landscape of the U.S., which living with a host family can greatly reduce.</p>
                        
                           <h5>What is RoomMagnet’s HomeshareSmarter® Living option?</h5> 
                            <p>Tenants who are open to assisting host families with some basic chores like running errands, doing yard work or just providing companionship or personal assistance will receive a discount on their housing. We call this HomeShareSmarter® Living.</p>
                        
                           <h5>Who are RoomMagnet’s Advisors?</h5> 
                            <p>Our advisors are available to assist hosts who would rather sit back and experience the benefits of the RoomMagnet program but not the hassle of getting set up. Email us today and let us set up a personal meeting with one of our advisors to walk you through the process. It’s that easy!</p>
                           ...
                           <h5>What is the cost of my criminal background check?</h5> 
                            ...
                            <p>The cost of securing your criminal background check with Intellicorp is $24.95. (Use this link to begin your criminal background check. Be sure to enter the password located below link:</p>
                        
                            <p>Intellicorp Records will provide a link to request copy of your background report once it is completed .</p>
                        
                           <h5>What is the cost of becoming part of the RoomMagnet community?</h5> 
                            <p>RoomMagnet does not charge either Tenants or Hosts a fee to register, develop a profile, list a property or search. Upon a confirmed letter of intent, tenants will be required to pay the first and last month’s rent.</p>
                        
                            <p>RoomMagnet earns a match fee of one month’s rent once Host and Tenants connect and initiate the company’s letter of intent indicating a desirable match and a start date for occupancy. </p>
                        
                            <p>Such commission will be deducted from the first month’s base rental rate with the balance then forwarded to the host. On Lease agreements that are sixty (60) days or less Roommagnet will only require a 30% commission of the total lease term rental.</p>
                           ...
                           <h5>How can I get involved with RoomMagnet?</h5> 
                            <p>How can I get involved with RoomMagnet?
                            ...
                            <p>Send us an e mail, tell us a little about yourself ,send us an example of your writing and we’ll get back to you. And if you’re unsure about your writing, we have great people here at RoomMagnet that will help turn your pieces into first rate work. Come on! We’re waiting for you.</p>
            ...
            <section class="px-5 py-5  shadow-sm " id="ourPolicy">
                <div class="row">
                    <div class="col-md-12">
                        <h3>Our Policy</h3>
